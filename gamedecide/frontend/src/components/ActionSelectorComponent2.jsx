...
function ActionSelectorComponent2({id, itemList, label, action, map, validCheck, text}) {
    ...
    function handleSubmit() {
        const selectedItem = itemList.find(item => item.name=== input);
        if (selectedItem) {
...
export default ActionSelectorComponent2
